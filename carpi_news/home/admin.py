...
class ArticoloAdmin(admin.ModelAdmin):
    ...
    list_display = ("titolo", "categoria", "tags", "spotlight_display", "is_pubbliredazionale", "payment_status_display", "approvato", "escludi_newsletter", "data_pubblicazione", "views", "fonti_web_count")
    ...
    search_fields = ['titolo', 'slug', 'tags', 'nome_azienda', 'sito_web', 'pubbliredazionale_user__username']
    ...
    def get_fieldsets(self, request, obj=None):
        ...
        if obj and obj.is_pubbliredazionale:
            return (
                ('Informazioni Base', {
                    'fields': ('titolo', 'slug', 'contenuto', 'sommario', 'categoria', 'tags', 'foto', 'foto_upload')
                }),
            ...
            return (
                ('Informazioni Base', {
                    'fields': ('titolo', 'slug', 'contenuto', 'sommario', 'categoria', 'tags', 'data_evento', 'foto', 'foto_upload')
                }),
                ('Pubblicazione', {
