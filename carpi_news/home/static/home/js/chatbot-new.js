            ...
            articlesHtml += `
                <a href="${article.url}" class="article-card">
                    ...
                    <div class="article-content">
                        ...
                        <h4 class="article-title" style="font-size: 10px !important;">${this.escapeHtml(article.titolo)}</h4>
                        <p class="article-summary" style="font-size: 11px !important;">${this.escapeHtml(article.sommario)}</p>
