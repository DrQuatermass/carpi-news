...
class Command(BaseCommand):
    help = "Pulisce file in media/images/downloaded non referenziati da nessun articolo."
    ...
    def handle(self, *args, **options):
        ...
        downloaded_dir = media_root / "images" / "downloaded"

        if not downloaded_dir.exists():
            self.stdout.write(self.style.WARNING(f"Cartella non trovata: {downloaded_dir}"))
            return
